...
mixin _$MapViewModel on _MapViewModelBase, Store {
  late final _$isLoadingAtom = Atom(
    name: '_MapViewModelBase.isLoading',
    context: context,
  );
  ...
  late final _$mapModelItemsAtom = Atom(
    name: '_MapViewModelBase.mapModelItems',
    context: context,
  );
  ...
  late final _$selectedIndexAtom = Atom(
    name: '_MapViewModelBase.selectedIndex',
    context: context,
  );
  ...
  late final _$fetchAllMapsAsyncAction = AsyncAction(
    '_MapViewModelBase.fetchAllMaps',
    context: context,
  );
  ...
  late final _$_MapViewModelBaseActionController = ActionController(
    name: '_MapViewModelBase',
    context: context,
  );
